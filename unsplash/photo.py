...
class Photo(Client):
    ...
    def _all(self, url, page: int = 1, per_page: int = 10, order_by: str = "latest"):
    ...
    def all(self, page: int = 1, per_page: int = 10, order_by: str = "latest"):
        return self._all("/photos", page=page, per_page=per_page, order_by=order_by)

    def curated(self, page: int = 1, per_page: int = 10, order_by: str = "latest"):
        """
    ...
    def search(self, query, category=None, orientation=None, page: int = 1, per_page: int = 10):
        """
